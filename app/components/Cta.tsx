...
export function Cta() {
  return (
    <div className='w-full rounded-[16px] bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[250px] lg:py-[88px]'>
      <h1 className='text-white text-[32px] font-medium lg:text-[56px] lg:leading-[64px]'>
        Monitor your website like a pro
      </h1>
      <p className='text-white pt-6 lg:pt-12 lg:text-[18px]'>
        Join over 800+ happy site owners boosting productivity and efficiency!
      </p>

      <div className='mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row justify-center gap-x-10'>
        ...
        <button className='flex w-full items-center justify-center gap-x-3 mt-[32px] text-white font-medium lg:w-fit lg:mt-0'>
          Contact Sales
          <span className='ml-1'>
            <Image src={Arrow} alt='arrow' className='h-7 w-7' />
          </span>
        </button>
      </div>
    </div>
